...
==187== 
==187== HEAP SUMMARY:
==187==     in use at exit: 281 bytes in 3 blocks
==187==   total heap usage: 11 allocs, 8 frees, 8,818 bytes allocated
==187== 
==187== 16 bytes in 1 blocks are definitely lost in loss record 2 of 3
==187==    at 0x4C2DB8F: malloc (in /usr/lib/valgrind/vgpreload_memcheck-amd64-linux.so)
==187==    by 0x401841: add_process (in /tmp/tmptf34d_97/shell)
==187==    by 0x4014AD: shell (in /tmp/tmptf34d_97/shell)
==187==    by 0x402E85: main (in /tmp/tmptf34d_97/shell)
==187== 
==187== LEAK SUMMARY:
==187==    definitely lost: 16 bytes in 1 blocks
==187==    indirectly lost: 0 bytes in 0 blocks
==187==      possibly lost: 0 bytes in 0 blocks
==187==    still reachable: 265 bytes in 2 blocks
